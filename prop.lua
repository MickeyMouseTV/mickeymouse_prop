...
attachPropList = {
	{["model"] = "xm_prop_smug_crate_s_medical",	["name"] = "emsbox", 		["bone"] = 28422, ["x"] = 0.0,	["y"] = -0.1,	["z"] = -0.1,	["xR"] = 0.0,	["yR"] = 0.0, 	["zR"] = 0.0, 	["anim"] = 'hold' }, -- Done
	{["model"] = 'xm_prop_x17_bag_med_01a',			["name"] = "emsbag", 		["bone"] = 28422, ["x"] = 0.4,	["y"] = -0.1,	["z"] = -0.1,	["xR"] = 315.0,	["yR"] = 298.0, ["zR"] = 0.0, 	["anim"] = 'pick' } -- Done
}
...
AddEventHandler('inrp_propsystem:attachProp', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
	exports['mythic_notify']:DoHudText('inform', 'Tryk Y for at Samle/Sæt objektet. /r for at fjerne objektet')
    closestEntity = 0
    holdingPackage = true
